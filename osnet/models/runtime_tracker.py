...
class RuntimeTracker:
    def __init__(self, det_score_thresh: float = 0.7, track_score_thresh: float = 0.6,
                 ...
                 reid_model: str = 'osnet_x1_0', reid_path: str = None):
        ...
        # OsNet ReID components
        self.use_reid = use_reid
        self.reid_thresh = reid_thresh
        self.reid_extractor = ReIDExtractor(model_name=reid_model, model_path=reid_path) if use_reid else None
