...
def parse_option():
    ...
    # About Paths:
    # Config file:
    parser.add_argument("--config-path", type=str, help="Config file path.", default="./configs/sambamotr/dancetrack/def_detr/train_residual_masking_sync_longer_10_expand_2_hdim_4_layers_4.yaml")
    # Data Path:
